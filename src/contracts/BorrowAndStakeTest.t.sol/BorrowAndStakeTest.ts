...
export interface BorrowAndStakeTestInterface extends utils.Interface {
  functions: {
    ...
    "tba()": FunctionFragment;
    "testBorrowSuccess()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "tba", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "testBorrowSuccess",
    values?: undefined
  ): string;
  ...
  decodeFunctionResult(functionFragment: "tba", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "testBorrowSuccess",
    data: BytesLike
  ): Result;
...
export interface BorrowAndStakeTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BorrowAndStakeTestInterface;
  ...
  functions: {
    ...
    tba(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    testBorrowSuccess(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    tba(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    tba(overrides?: CallOverrides): Promise<PopulatedTransaction>;
