...
export interface ReferenceERC6551RegistryInterface extends utils.Interface {
  functions: {
...
export interface ReferenceERC6551Registry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReferenceERC6551RegistryInterface;
